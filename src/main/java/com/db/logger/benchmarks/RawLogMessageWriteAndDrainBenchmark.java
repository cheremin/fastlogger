...
/**
 * RawLogMessage -- with explicit .start() method
 *
 * @author ruslan
...
@State( Scope.Group )
public class RawLogMessageWriteAndDrainBenchmark {
	...
	public void writeFormatted( final ThreadState ts ) {
		...
		FluentLogBuilder logBuilder = ts.formatter.start();
		logBuilder = logBuilder.with( 5d );
...
//			BlackHole.consumeCPU( 100 );
	...
	public static class ThreadState {
		...
		public RawLogMessage formatter;

		public void setup( final RawLogMessageWriteAndDrainBenchmark b ) {
			formatter = new RawLogMessage(
	...
	public static void main( final String[] args ) throws Exception {
		final RawLogMessageWriteAndDrainBenchmark benchmark = new RawLogMessageWriteAndDrainBenchmark();
